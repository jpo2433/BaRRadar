...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, LocationListener, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng startingPoint = new LatLng(52.3728, 4.9);
        mMap.addMarker(new MarkerOptions().position(startingPoint).title("Starting point"));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(startingPoint, 90));
